...
import './LessonPlanVideoUpload.css';
...
const LessonPlanVideoUpload = () => {
    ...
    const handleUpload = async (e) => {
        ...
        try {
            ...
            const res = await api.post('/lesson-plan-upload', finalForm, {
                timeout: 0,
    ...
    const handleViewReport = () => {
        navigate('/lesson-plan/reports', { state: { lectureId: completedLectureId } });
    };
                ...
                <div className="modal-overlay">
                    <div className="modal-content" style={{ textAlign: 'center', maxWidth: '500px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                            {/* <button
                                onClick={() => navigate('/lesson-plan/reports')}
                                style={{
...
export default LessonPlanVideoUpload;
