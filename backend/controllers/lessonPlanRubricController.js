...
const { Rubric } = require('../lessonPlanModels');
...
const upload = multer({
    ...
    fileFilter: function (req, file, cb) {
        ...
        // Browsers can sometimes send application/octet-stream or weird mimetypes for xlsx/docx
        // So we will primarily rely on the extension, but also check mimetype as a fallback
        const mimetype = /pdf|msword|officedocument|excel|spreadsheet|octet-stream/.test(file.mimetype);
